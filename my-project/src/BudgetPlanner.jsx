    ...
    <div className="bg-gray-50 min-h-screen p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl font-semibold text-gray-800">Budget Planning</h1>
            <div className="text-sm text-gray-600 mt-1">Track and manage your monthly budgets</div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-sm font-medium">Total Budget: ${budgetData.totalBudget.toLocaleString()}</span>
            </div>
            ...
            <div className="space-y-4">
              {budgetData.categories.map((category, index) => (
                <div key={index} className="mb-3">
                  ...
                  <div className="text-xs text-gray-500 mb-1">{category.percentSpent}% spent</div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-sm font-medium pt-3 border-t border-gray-100 mt-2">
                  ...
                  <span className="text-green-600">${remainingToBudget.toLocaleString()}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="flex justify-between text-sm mb-2">
                <span>Target: ${budgetData.savingsGoal.target.toLocaleString()}</span>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h2 className="text-base font-semibold mb-4">Monthly Spending Trend</h2>
          <div className="bg-gray-100 w-full h-64 flex items-center justify-center text-gray-400 text-lg rounded-lg">
            800 × 300
          </div>
        </div>
