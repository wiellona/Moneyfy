  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-purple-200">
      ...
      {/* <header className="bg-white px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        <div className="font-bold text-xl">MoneyFy</div>
        <div className="flex items-center gap-6">
          <nav className="hidden md:flex gap-6">
            <a href="#" className="text-gray-700 hover:text-gray-900">About us</a>
            <a href="#" className="text-gray-700 hover:text-gray-900">Our Features</a>
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700">Logout</button>
          </div>
        </div>
      </header> */}
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-3xl shadow-md p-6 md:p-8">
          <h1 className="text-2xl font-bold text-center mb-6">Add Transactions</h1>
          
          {/* Transaction Type Selector */}
          <div className="grid grid-cols-2 gap-4 mb-6">
            <button
              className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg ${
                transactionType === 'expense' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700'
              }`}
            ...
            <button
              className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg ${
                transactionType === 'income' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700'
              }`}
      ...
      {/* Footer */}
      {/* <footer className="bg-white mt-12 py-12 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8"> */}
            {/* Logo and Description */}
            {/* <div>
              <div className="font-bold text-xl mb-2">MoneyFy</div>
              <p className="text-sm text-gray-600">Your smart financial companion for better money management.</p>
              <p className="text-xs text-gray-500 mt-6">© 2023 MoneyFy. All rights reserved.</p>
            </div> */}
